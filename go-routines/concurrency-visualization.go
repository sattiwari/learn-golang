...
func visualize(rw http.ResponseWriter, req *http.Request) {
	...
	outputSVG.Text(20, 30, "Process 1 Timeline", "text-anchor:start;font-size:120px;fill:#333333")
    outputSVG.Rect(10, 130, 780, 100, "fill:#eeeeee;stroke:none")
    outputSVG.Text(20, 150, "Process 2 Timeline", "text-anchor:start;font-size:120px;fill:#333333")
